        ...
        <div class="container__payment">
            ...
            <div class="form-payment">
                <div class="products">
                    ...
                    <div class="total">Amount to be paid<span class="price">{{$data->payment_amount}} {{$data->currency_code}}</span></div>
                </div>
...
<script>
    const mercadopago = new MercadoPago('{{$config->public_key}}');

    loadCardForm();
    function loadCardForm() {
        const productCost = '{{$data->payment_amount}}';
        const productDescription = '{{'Payment for order id:'.$data->id}}';
        ...
        const cardForm = mercadopago.cardForm({
            ...
            callbacks: {
                ...
                onSubmit: event => {
                    ...
                    fetch("{{route('mercadopago.make_payment',request()->getQueryString()).'&payment_id='.$data->id}}", {
                        method: "POST",
                        headers: {
